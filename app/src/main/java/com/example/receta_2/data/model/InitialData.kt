...
val sampleRecipes: List<Recipe> = listOf(
    ...
    Recipe("principal_01", "Lasaña a la Boloñesa", "Un clásico de la cocina italiana que nunca falla, perfecto para una comida familiar.", "https://picsum.photos/id/219/800/600",
    ...
    // --- RECETAS DE POSTRES ---
    Recipe("postre_01", "Tarta de Manzana Casera", "Una tarta rústica y deliciosa con un toque de canela.", "https://picsum.photos/id/431/800/600",
    ...
    // --- RECETAS DE DESAYUNO ---
    Recipe("desayuno_01", "Tostadas con Aguacate y Huevo", "Un desayuno completo, nutritivo y muy rápido de preparar.", "https://picsum.photos/id/180/800/600",
